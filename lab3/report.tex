...
\begin{figure}[ht]
\centering
\includegraphics[width=0.6\textwidth]{Diagram1} % Укажите имя файла изображения и его ширину
\caption{Модель “Сущность-связь”} % Здесь вы можете указать название рисунка или его описание.
\label{fig:er_model}
\end{figure}
